...
JWT_SECRET_KEY=your-secret-jwt-key-here  # Required for admin authentication
ADMIN_REGISTRATION_KEY=your-secret-registration-key  # Required for admin registration
```
